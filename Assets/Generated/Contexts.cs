...
public partial class Contexts : Entitas.IContexts {
    ...
    public ControllerContext controller { get; set; }
    public InputContext input { get; set; }
    public PlayerContext player { get; set; }
    public SystemContext system { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { controller, input, player, system }; } }
...
public partial class Contexts {
    ...
    public void InitializeContextObservers() {
        try {
            CreateContextObserver(controller);
            CreateContextObserver(input);
            CreateContextObserver(player);
            CreateContextObserver(system);
